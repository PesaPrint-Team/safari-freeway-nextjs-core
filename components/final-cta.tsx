...
export function FinalCta() {
  return (
    <section className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 sm:pb-20 lg:px-8">
      <div className="rounded-[2.2rem] border border-[var(--line)] bg-[linear-gradient(120deg,rgba(207,52,57,0.18),rgba(255,255,255,0.04))] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] sm:p-8">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <Button glow onClick={() => scrollToId('book-demo')}>Book Executive Demo</Button>
